...
echo -e "${CYAN}Stripping first 4 lines from${NC} ${YELLOW}$RAW${NC} …"
...
./"$BIN" "$RAW" ../benchmark/resources/livejournal/livejournal_R.bin

mv "$RAW" ../benchmark/resources/livejournal/livejournal.csv
echo -e "${GREEN}Processed data is in${NC} ${YELLOW}/benchmark/resources/livejournal/${NC}"
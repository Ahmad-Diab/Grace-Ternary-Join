...
std::unique_ptr<external_join::CounterOperator> constructJoinOperator(Database& db) {
    ...
    external_join::Table &s = db.GetTable("livejournal_S");
    external_join::Table &t = db.GetTable("livejournal_T");
...
int main() {
    ...
    benchmarkFramework.addTask("livejournal-binary-external-hash-join", &f2, 68993773);
